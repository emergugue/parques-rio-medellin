				...
				<div class="meta-box-sortables">
					...
					<div class="column-right">
						...
						<div class="postbox">
							...
							<div class="inside">
								<div>
									<p class=""><input type="submit" name="save-background-options" id="save-background-options" class="add-pages-button button button-primary" value="Add Pages From Gallery (select / upload JPG pages)"></p>
									...
									<div class="ui-sortable sortable-pages-body">
										<p class=""><a class="delete-all-pages-button alignleft button-secondary " href='#'>Delete All Pages</a></p>
										<br/>
										<br/>
...
wp_enqueue_script("read3d_flipbook_admin", plugins_url()."/real3d-flipbook/js/plugin_admin.js", array('jquery','jquery-ui-sortable','jquery-ui-resizable','jquery-ui-selectable','jquery-ui-tabs','pdfjs' ),REAL3D_FLIPBOOK_VERSION);
